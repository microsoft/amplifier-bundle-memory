# suggestions.v3 — the daily suggestion inbox (Phase 2) (FROZEN 2026-09-08)

**Status:** FROZEN 2026-09-08 · **Governs:** `amplifier-memory suggest` and the timer that
...
- **2026-09-08 — v3 locked.** The steward ratified the Core 3 replacement
  question. The v2 history below remains the record of what earlier work was
  built against.
