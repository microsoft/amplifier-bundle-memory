# session.v4 — what happens inside an Amplifier session (FROZEN 2026-09-07)
...
**Supersedes:** `session.v3.md` (locked 2026-09-07, amended the same day;
changed by the ratified proposal `session.v3.v4-candidate.md`).
