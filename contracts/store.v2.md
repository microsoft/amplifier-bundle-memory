# store.v2 — the memory directory on disk (FROZEN 2026-09-06)
...
**Supersedes:** `store.v1.md` (locked 2026-09-06 14:28; changed by the
ratified proposal `store.v1.v2-candidate.md`).
